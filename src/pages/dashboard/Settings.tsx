...
import {
  User, Mic, Bell, Shield, Save, Bluetooth,
} from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl p-6 border border-gray-200 dark:border-gray-700 shadow-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Security & Authentication</h2>
        </div>

        <div className="space-y-4">
          {/* ✅ Dedicated biometric component */}
          <BiometricSetup />
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <p className="text-sm font-medium text-gray-900 dark:text-white">Configure Voice Lock</p>
                <p className="text-xs text-gray-600 dark:text-gray-400">Set up or update voice passphrase</p>
              </div>
            </div>
          </button>
        </div>
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl p-6 border border-gray-200 dark:border-gray-700 shadow-lg">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-2xl">
            <label className="block text-sm font-medium text-gray-900 dark:text-white mb-3">Alert Sensitivity</label>
            <select
              value={preferences.alert_sensitivity}
              onChange={(e) => setPreferences({ ...preferences, alert_sensitivity: e.target.value })}
      ...
      <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl p-6 border border-gray-200 dark:border-gray-700 shadow-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Bluetooth & Device Alerts</h2>
        </div>
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Send alerts to paired Bluetooth devices when unusual activity is detected.
        </p>
        <button
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              <p className="text-sm font-medium text-gray-900 dark:text-white">Manage Device Connections</p>
              <p className="text-xs text-gray-600 dark:text-gray-400">Pair or remove Bluetooth devices</p>
            </div>
          </div>
